      ...
      <div style={{ maxWidth: '400px', margin: '20px auto' }}>
        ...
        <form onSubmit={handleSubmit}>
          <table style={{ width: '100%', border: 'none' }}>
            <tbody>
              <tr>
                <td style={{ border: 'none', padding: '5px', fontWeight: 'bold', width: '100px' }}>Username:</td>
        ...
        <div style={{ textAlign: 'center', fontSize: '10px', color: '#666', background: '#ffffee', padding: '8px', border: '1px solid #ddd' }}>
          <strong>Privacy Notice:</strong> We do not collect any personal data. Your credentials are stored securely and are only used for login purposes. No tracking, no data sharing.
        </div>
